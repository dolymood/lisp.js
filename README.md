...
参考Peter Norvig的 <a href='http://norvig.com/lispy.html'>How to Write a (Lisp) Interpreter (in Python)</a>。
文件wangjianbo--lisp解析器--test.html和guanyuxin--Lisp词法分析.html为朋友写的。
